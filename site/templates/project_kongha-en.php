...
<body>
  ...
  <footer class="footer">
    <div class="navigation">
      ...
      <a style="text-decoration: none;" class="bottom" href="<?= $prev->url() ?>"><span class="material-symbols-sharp">
          arrow_back
        </span></a>
      <?php endif ?>

      <?php if($next = $page->next()): ?>
      <a style="text-decoration: none;" class="bottom" href="<?= $next->url() ?>"><span class="material-symbols-sharp">
          arrow_forward
        </span></a>
      <?php endif ?>
    </div>
